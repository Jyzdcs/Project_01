const bdnQuestions = [
    {
        ...
        url1: "https://assets.goal.com/v3/assets/bltcc7a7ffd2fbf71f5/blt64890c907349b031/60db38a98491e60f790a36a9/0d5815259ae6a395605fe51fb0bad3a8fe928351.jpg?auto=webp&format=pjpg&width=3840&quality=60", //Cristiano Ronaldo, true
        ...
        url4: "https://media.ouest-france.fr/v1/pictures/MjAyMzEyOGIxYjNmNDg5MTdkN2NlYTdkMjMzOGI2NmZkNjZjMTc?width=1260&height=708&focuspoint=31%2C15&cropresize=1&client_id=bpeditorial&sign=535ef6168b60cf8b33aa54e2566dfab8eb6d72494c086ecb8fa277e77494a9bf", //Kylian Mbappé, //
    },
    {
        id: "02",
...
let numberAlreadyOut = [];

for(i = 0; i < 10; i++){
    setTimeout(() => {
        let randomNumber = Math.floor(Math.random() * 10);
        
        if(!(numberAlreadyOut.includes(randomNumber))){
            questionRandom.textContent = bdnQuestions[randomNumber].question;
            imageOne.src = bdnQuestions[randomNumber].url1;
            imageTwo.src = bdnQuestions[randomNumber].url2;
            imageTree.src = bdnQuestions[randomNumber].url3;
            imageFour.src = bdnQuestions[randomNumber].url4;
            numberAlreadyOut.push(randomNumber);
        }
        console.log(numberAlreadyOut);
    }, i * 1000);
}


//imageTree.src = bdnQuestions[0].url4
